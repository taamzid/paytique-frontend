...
const Overview = () => {
  ...
  return (
    <div className="bg-[#ffffff] smd:grid smd:grid-cols-[1fr_2.5fr_1.5fr] slg:grid-cols-[.9fr_3fr_1fr] lg:grid-cols-[.8fr_3fr_1.1fr] h-[100vh]">
      <LeftDash />
      <div className="bg-[#ffffff] smd:bg-transparent overflow-y-auto pb-[30px] [&::-webkit-scrollbar]:hidden [-ms-overflow-style]:hidden [scrollbar-width]:hidden">
        <Common />
        <div className="bg-[#ffffff] px-[20px] flex items-center justify-center gap-[10px] smd:gap-[20px] mt-[25px] smd:mt-[0px]">
          <div
        ...
        <div className="bg-[#ffffff] smd:bg-transparent px-[20px] smd:px-[0px]">
          <div className="bg-[#ffffff] smd:bg-transparent flex items-center justify-center">
