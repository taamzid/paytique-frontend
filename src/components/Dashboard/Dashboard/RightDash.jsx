...
const RightDash = () => {
  return (
    <div className="flex items-start justify-center shadow-xl">
      <div className="px-[32px]">
        ...
        <div className="mt-[64px] flex items-center justify-center gap-[15px] mb-[50px] cursor-pointer">
          <div className="flex items-center  justify-center bg-[#196BFE] font-SFMedium rounded-full w-[167px] h-[53px]">
            <h1 className="text-center text-[#ffffff]">Edit cards</h1>
          </div>
          <div className="flex items-center  justify-center bg-[#196BFE] font-SFMedium rounded-full w-[167px] h-[53px] cursor-pointer">
            <h1 className="text-center text-[#ffffff]">Overview</h1>
          </div>
        </div>
      </div>
    </div>
