...
const ModalPass = ({ isOpen, onClose, onConfirm, title, deleteMessage }) => {
  if (!isOpen) return null;

  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
      <div className="bg-white px-[40px] py-[30px] rounded-[10px] shadow-lg">
        ...
        <input
          type="text"
          className="mt-[10px] mb-[10px] w-full smd:w-[450px] bg-[#F3F3F3] h-[50px] font-normal text-[18px] rounded-[6px] text-[#AFAFAF] px-[15px]"
