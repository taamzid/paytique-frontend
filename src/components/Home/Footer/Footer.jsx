      ...
      <div className="container mx-auto pt-[50px] px-[40px] smd:pt-[100px] pb-[55px] smd:pb-[105px] smd:flex items-center justify-between">
        <div className="">
          <div className="flex items-center gap-[17px]">
            ...
            />
            <h1 className="text-[30px] smd:text-[45px] slg:text-[53px] font-SFSemibold text-[#196BFE]">
              Paytique Financial
            </h1>
          </div>
          <h1 className="text-[14px] mt-[20px] slg:text-[16px] smd:mt-[16px] lg:mt-[20px] smd:ml-[102px]">
            H-46, Rd-65 P.O. ERD West California, United States. <br />
            Call: 90843454393 &nbsp; &nbsp; Email: tyere@gmail.com
          </h1>
        </div>
        <div className="grid grid-cols-2 place-items-center smd:flex smd:gap-[40px] slg:gap-[82px] mt-[48px] smd:mt-[0px]">
          <div>
            <h1 className="text-[#ffffff]">Legal</h1>
            <div className="smd:text-[14px] slg:text-[16px] mt-[20px] text-[#a3a1a1]">
