    ...
    <div>
      <div className="flex items-center">
        ...
        <div className="flex items-center smd:gap-[30px] lg:gap-[60px] ml-[10px] text-[#ffffff]">
          <h1 className="smd:text-[24px] lg:text-[32px] font-SFSemiBold cursor-pointer">
            Paytique Financial
          </h1>
          <div className="flex items-center smd:gap-[30px] lg:gap-[60px] smd:text-[14px] lg:text-[16px] font-SFSemiBold">
